...
{
    public class RecurringDateTimeJobManagerFacts
    {
        ...
        public RecurringDateTimeJobManagerFacts()
        {
        ...
        public void Ctor_ThrowsAnException_WhenStorageIsNull()
        {
            var exception = Assert.Throws<ArgumentNullException>(
                () => new RecurringDateRangeJobManager(null, _factory.Object));
        ...
        {
            var exception = Assert.Throws<ArgumentNullException>(
                () => new RecurringDateRangeJobManager(_storage.Object, null));
        ...
        public void AddOrUpdate_ThrowsAnException_WhenQueueNameIsNull()
        {
            ...
            var exception = Assert.Throws<ArgumentNullException>(
                () => manager.AddOrUpdate(_id, _job, Cron.Daily(), TimeZoneInfo.Local, null, null, null));
        ...
        public void AddOrUpdate_ThrowsAnException_WhenQueueIsNull()
        {
            ...
            var exception = Assert.Throws<ArgumentNullException>(
                () => manager.AddOrUpdate(_id, _job, _cronExpression, TimeZoneInfo.Utc, null, null, null));
        ...
        public void AddOrUpdate_AddsAJob_ToTheRecurringJobsSet()
        {
            ...
            _transaction.Verify(x => x.AddToSet(PluginConstants.JobSet, _id));
        }
        ...
        {
            // Arrange
            _connection.Setup(x => x.GetAllEntriesFromHash($"{PluginConstants.JobType}:{_id}"))
        ...
        public void RemoveIfExists_RemovesEntriesAndCommitsTheTransaction()
        {
            ...
            _transaction.Verify(x => x.RemoveFromSet(PluginConstants.JobSet, _id));
            _transaction.Verify(x => x.RemoveHash($"{PluginConstants.JobType}:{_id}"));
            _transaction.Verify(x => x.Commit());
        }

        private RecurringDateRangeJobManager CreateManager()
        {
            return new RecurringDateRangeJobManager(_storage.Object, _factory.Object);
        }
